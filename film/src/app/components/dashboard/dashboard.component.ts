...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    // this.data =document.getElementsByTagName('a');    
 
  }
  moviesname= ['Deadpool','We"re the Millers', 'Straight Outta Compton', 'Gridiron Gang','American Gangster','Gangster Squad','Now You See Me','Jurassic World',
  'Mission: Impossible: Rogue Nation','The Man from U.N.C.L.E.','Spectre','Legend','Southpaw','Bridge of Spies','Ant-Man','Fast & Furious 7','Tracers',
  'Running Scared','The Hangover','Project X','The Dark Knight','The Tournament','The Matrix','Bad Boys'
   ];
  movies: any[] = [
    {
      id: 1,
